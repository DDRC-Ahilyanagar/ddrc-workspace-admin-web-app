  ...
  return (
    <div className={`min-h-screen font-sans text-slate-800 bg-white selection:bg-[#009cc5]/20 overflow-x-hidden ${getFontSizeClass()}`}>
      ...
      <main className="relative">
        <section className="relative min-h-screen flex items-center justify-center pt-40 md:pt-48 pb-20 overflow-hidden bg-gradient-to-br from-[#003f86] via-[#003f86] to-[#009cc5]">
