-- SQL Query to update multiple users (IDs: 20, 12, 11, 10) to verification officers
-- This ensures all users have the required fields set correctly
...
-- Step 4: Update users with IDs 20, 12, 11, 10 to verification officers
UPDATE users
SET 
